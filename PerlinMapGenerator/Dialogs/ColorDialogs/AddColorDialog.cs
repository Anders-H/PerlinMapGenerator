...
public partial class AddColorDialog : Form
{
    ...
    private void AddColorDialog_Load(object sender, EventArgs e)
    {
        ...
        var color = System.Drawing.Color.FromArgb(255, PerlinRandom.GetRgb(), PerlinRandom.GetRgb(), PerlinRandom.GetRgb());
        ...
        trbHighestValue.Value = PerlinRandom.GetInt(10, 91);
